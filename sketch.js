        ...
        for(let y = 0; y < RETICULA; y++ ){
          ...
          image(azulejos[indiceDeAzulejo],
             ...
             if(!celdaUP.colapsada) {
                cambiarEntropia(celdaUP, reglasActuales['UP'], 
                'DOWN'
                );
              }
             }
             ...
             if(x < RETICULA - 1){
                ...
                if(!celdaRIGHT.colapsada) {
                    cambiarEntropia(celdaRIGHT, reglasActuales['RIGHT'], 
                'LEFT'
                );
                 }
            }
             ...
             if(y < RETICULA - 1){
                ...
                if(!celdaDOWN.colapsada) {
                    cambiarEntropia(celdaDOWN, reglasActuales['DOWN'], 
                    'UP'
                    );
                 }
            }
             ...
             if(x > 0){
                ...
                if(!celdaLEFT.colapsada) {
                    cambiarEntropia(celdaLEFT, reglasActuales['LEFT'], 
                    'RIGHT'
                    );
                 }
            }
